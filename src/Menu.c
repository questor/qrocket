...
MenuDescriptor g_fileMenu[] = {
    ...
    {_T(""), EDITOR_MENU_SEPARATOR, 0, 0, 0},
    {_T("Quit"), EDITOR_MENU_QUIT, 'w', EMGUI_KEY_COMMAND, EMGUI_KEY_CTRL},
    {0},
};
...
MenuDescriptor g_editMenu[] = {
    ...
    {_T(""), EDITOR_MENU_SEPARATOR, 0, 0, 0},
    {_T("Step Interpolation"), EDITOR_MENU_SETSTEP, '1', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Linear Interpolation"), EDITOR_MENU_SETLINEAR, '2', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Smooth Interpolation"), EDITOR_MENU_SETSMOOTH, '3', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Ramp Interpolation"), EDITOR_MENU_SETRAMP, '4', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T(""), EDITOR_MENU_SEPARATOR, 0, 0, 0},
